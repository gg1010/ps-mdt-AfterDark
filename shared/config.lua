...
Config.PenalCode = {
    [1] = {
        [1] = {title = 'Vold', class = 'Forbrydelser', id = '§ 1.1', months = 15, fine = 8000, color = 'orange'},
        [2] = {title = 'Grov vold', class = 'Forbrydelser', id = '§ 1.2', months = 25, fine = 12000, color = 'orange'},
        [3] = {title = 'Vold mod tjenestemand', class = 'Forbrydelser', id = '§ 1.3', months = 25, fine = 10000, color = 'orange'},
        [4] = {title = 'Grov vold mod tjenestemand', class = 'Forbrydelser', id = '§ 1.4', months = 35, fine = 14000, color = 'orange'},
        [5] = {title = 'Trusler mod civil', class = 'Forbrydelser', id = '§ 1.5', months = 10, fine = 5500, color = 'orange'},
        [6] = {title = 'Trusler mod tjenestemand', class = 'Forbrydelser', id = '§ 1.6', months = 10, fine = 7700, color = 'orange'},
        [7] = {title = 'Mordforsøg', class = 'Forbrydelser', id = '§ 1.8', months = 25, fine = 25000, color = 'orange'},
        [8] = {title = 'Mordforsøg på tjenestemand', class = 'Forbrydelser', id = '§ 1.9', months = 40, fine = 35000, color = 'orange'},
        [9] = {title = 'Manddrab', class = 'Forbrydelser', id = '§ 1.10', months = 75, fine = 40000, color = 'orange'},
        [10] = {title = 'Manddrab på tjenestemand', class = 'Forbrydelser', id = '§ 1.11', months = 60, fine = 50000, color = 'orange'},
        [11] = {title = 'Dødstrussel', class = 'Forbrydelser', id = '§ 1.12', months = 15, fine = 8000, color = 'orange'},
        [12] = {title = 'Uagtsomt manddrab', class = 'Forbrydelser', id = '§ 1.13', months = 20, fine = 20000, color = 'orange'},
        [13] = {title = 'Butiksrøveri', class = 'Forbrydelser', id = '§ 1.15', months = 25, fine = 20000, color = 'orange'},
        [14] = {title = 'Væbnet Butiksrøveri', class = 'Forbrydelser', id = '§ 1.16', months = 30, fine = 23000, color = 'orange'},
        [15] = {title = 'Bankrøveri/Juvelrøveri', class = 'Forbrydelser', id = '§ 1.17', months = 30, fine = 45000, color = 'orange'},
        [16] = {title = 'Væbnet bankrøveri/juveærvero', class = 'Forbrydelser', id = '§ 1.18', months = 40, fine = 65000, color = 'orange'},
        [17] = {title = 'Røveri mod National Banken', class = 'Forbrydelser', id = '§ 1.19', months = 60, fine = 80000, color = 'orange'},
        [18] = {title = 'Væbnet røveri mod person', class = 'Forbrydelser', id = '§ 1.20', months = 15, fine = 19000, color = 'orange'},
        [19] = {title = 'Forsøg på kidnapning', class = 'Forbrydelser', id = '§ 1.22', months = 20, fine = 25000, color = 'orange'},
        [20] = {title = 'Kidnapning', class = 'Forbrydelser', id = '§ 1.23', months = 40, fine = 35000, color = 'orange'},
        [21] = {title = 'Flugt fra fængsel(Double tid)', class = 'Forbrydelser', id = '§ 1.25', months = 15, fine = 15000, color = 'orange'},
        [22] = {title = 'Fængselsudbrud', class = 'Forbrydelser', id = '§ 1.26', months = 30, fine = 10000, color = 'orange'},
        [23] = {title = 'Terrorisme', class = 'Forbrydelser', id = '§ 1.28', months = 50, fine = 100000, color = 'orange'},
        [24] = {title = 'Terrortrusler', class = 'Forbrydelser', id = '§ 1.29', months = 50, fine = 50000, color = 'orange'},
        [25] = {title = 'Brandstiftelse', class = 'Forbrydelser', id = '§ 1.31', months = 25, fine = 30000, color = 'orange'},
        [26] = {title = 'Dyremishandling', class = 'Forbrydelser', id = '§ 1.32', months = 10, fine = 20000, color = 'orange'},
    },
    [2] = {
        [1] = {title = 'Besiddelse af klasse 1 våben', class = 'Forbrydelse', id = '§ 2.1', months = 15, fine = 25000, color = 'orange'},
        [2] = {title = 'Besiddelse af klasse 2-våben', class = 'Forbrydelse', id = '§ 2.2', months = 20, fine = 35000, color = 'orange'},
        [3] = {title = 'Besiddelse af slagvåben', class = 'Forbrydelse', id = '§ 2.3', months = 10, fine = 15000, color = 'orange'},
        [4] = {title = 'Besiddelse af stikvåben', class = 'Forbrydelse', id = '§ 2.4', months = 15, fine = 20000, color = 'red'},
        [5] = {title = 'Besiddelse af sprængstoffer', class = 'Forbrydelse', id = '§ 2.5', months = 40, fine = 75000, color = 'orange'},
        [6] = {title = 'Besiddelse af ulovlig ammunition', class = 'Forbrydelse', id = '§ 2.6', months = 5, fine = 5000, color = 'red'},
        [7] = {title = 'Våbenhandel', class = 'Forbrydelse', id = '§ 2.8', months = 25, fine = 45000, color = 'red'},
        [8] = {title = 'Våben affyret', class = 'Forbrydelse', id = '§ 2.9', months = 25, fine = 45000, color = 'red'},
    },
    [3] = {
        [1] = {title = 'Hampblade 1', class = 'Forbrydelse', id = 'P.C. 2001', months = 0.03, fine = 100, color = 'orange'},
        [2] = {title = 'joint 1', class = 'Forbrydelse', id = 'P.C. 2002', months = 0.5, fine = 575, color = 'orange'},
        [3] = {title = 'Kokainblade 1', class = 'Forbrydelse', id = 'P.C. 2004', months = 0.07, fine = 450, color = 'orange'},
        [4] = {title = 'Kokain 1', class = 'Forbrydelse', id = 'P.C. 2005', months = 0.1, fine = 875, color = 'red'},
        [5] = {title = 'Pakket brick 1', class = 'Forbrydelse', id = 'P.C. 2006', months = 25, fine = 40000, color = 'orange'},
        [6] = {title = 'Syre 1', class = 'Forbrydelse', id = 'P.C. 2007', months = 0.07, fine = 450, color = 'red'},
        [7] = {title = 'LSD 1', class = 'Forbrydelse', id = 'P.C. 2019', months = 0.1, fine = 875, color = 'red'},
        [8] = {title = 'Opium 1', class = 'Forbrydelse', id = 'P.C. 2019', months = 0.7, fine = 600, color = 'red'},
        [9] = {title = 'Morfin 1', class = 'Forbrydelse', id = 'P.C. 2019', months = 0.7, fine = 400, color = 'red'},
        [10] = {title = 'Heroin (Skunk) 1', class = 'Forbrydelse', id = 'P.C. 2019', months = 0.1, fine = 1600, color = 'red'},
        [11] = {title = 'Metadon 1', class = 'Forbrydelse', id = 'P.C. 2019', months = 0.07, fine = 100, color = 'red'},
        [12] = {title = 'Svampe 1', class = 'Forbrydelse', id = 'P.C. 2019', months = 0.1, fine = 350, color = 'red'},
        [13] = {title = 'Svampekasse 1', class = 'Forbrydelse', id = 'P.C. 2019', months = 2, fine = 2000, color = 'red'},
        [14] = {title = 'Metamfetamin 1', class = 'Forbrydelse', id = 'P.C. 2019', months = 0.5, fine = 2200, color = 'red'},
    },
    [4] = {
    ...
    [5] = {
        ...
        [19] = {title = 'Medvirkende til Kriminalitet (se skema på håndbogen t.h.)', class = 'Forbrydelse', id = 'P.C. 2019', months = 10, fine = 12500, color = 'red'},
    ...
    [6] = {
        ...
        [5] = {title = 'Flugt fra færdselsuheld med personskade', class = 'Forbrydelse', id = 'P.C. 2001', months = 40, fine = 100000, color = 'orange'},
